...
[admission webhook](/kong-ingress-controller/{{page.kong_version}}/deployment/admission-webhook/)
...
can monitor the `ingress_controller_translation_count` [Prometheus metric](/kong-ingress-controller/{{page.kong_version}}/references/prometheus/).

### Monitor for issues that require manual fixes

{{site.kic_product_name}}'s [Prometheus metrics](/kong-ingress-controller/{{page.kong_version}}/references/prometheus)
