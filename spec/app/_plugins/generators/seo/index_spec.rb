  ...
  describe '.generate' do
    ...
    it 'generates an index with the latest version of each page' do
      expect(subject).to eq({
        ...
        '/hub/kong-inc/jq/configuration/examples/' => { 'url' => '/hub/kong-inc/jq/configuration/examples/', 'page' => find_page_by_url('/hub/kong-inc/jq/configuration/examples/') },
        ...
        '/hub/kong-inc/jwt-signer/configuration/examples/' => { 'url' => '/hub/kong-inc/jwt-signer/configuration/examples/', 'page' => find_page_by_url('/hub/kong-inc/jwt-signer/configuration/examples/') },
        ...
        '/hub/acme/kong-plugin/configuration/examples/' => { 'url' => '/hub/acme/kong-plugin/configuration/examples/', 'page' => find_page_by_url('/hub/acme/kong-plugin/configuration/examples/') },
        ...
        '/kong-ingress-controller/VERSION/' => { 'url' => '/kong-ingress-controller/latest/', 'page' => find_page_by_url('/kong-ingress-controller/latest/'), 'version' => Gem::Version.new('9999.9.9') },
