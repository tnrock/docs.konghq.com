  ...
  describe '.generate' do
    ...
    it 'generates the sitemap' do
      expect(subject).to match_array([
        ...
        { 'changefreq' => 'weekly', 'priority' => '1.0', 'url' => '/hub/kong-inc/jq/configuration/examples/' },
        ...
        { 'changefreq' => 'weekly', 'priority' => '1.0', 'url' => '/hub/kong-inc/jwt-signer/configuration/examples/' },
        ...
        { 'changefreq' => 'weekly', 'priority' => '1.0', 'url' => '/hub/acme/kong-plugin/configuration/examples/' },
